...
public class ETable extends JTable {
    ...
    private Color alternateRowColor() {
        return GuiUtilities.isGtk() ? Color.WHITE : GuiUtilities.MAC_OS_ALTERNATE_ROW_COLOR;
    }
    ...
    protected void configureEnclosingScrollPane() {
        ...
        if (p instanceof JViewport) {
            ...
            if (gp instanceof JScrollPane) {
                ...
                final Component renderer = new JTableHeader().getDefaultRenderer().getTableCellRendererComponent(dummyTable, "", false, false, -1, 0);
